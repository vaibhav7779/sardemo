...
class OTPValidationPL extends StatefulWidget {
  const OTPValidationPL({super.key});

  @override
  State<OTPValidationPL> createState() => _OTPValidationPLState();
}

String cardSel = 'agent';

class _OTPValidationPLState extends State<OTPValidationPL> {
