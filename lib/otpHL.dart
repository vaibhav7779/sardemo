...
class OTPValidationHL extends StatefulWidget {
  const OTPValidationHL({super.key});

  @override
  State<OTPValidationHL> createState() => _OTPValidationHLState();
}

String cardSel = 'agent';

class _OTPValidationHLState extends State<OTPValidationHL> {
